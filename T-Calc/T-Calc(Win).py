...
ventanaDisplay.iconbitmap(f"{path.dirname(executable)}\_internal\icon.ico")
...
ventanaHistórico.iconbitmap(f"{path.dirname(executable)}\_internal\icon.ico")
...
cajas.pack(padx=5, pady=5)

#Frame de Botonera
botonera = Frame(ventanaDisplay, width="300", height="350", highlightthickness=0, bg="#2e2e2e")
botonera.pack(padx=5, pady=5)
...
cajaEntrada = Label(cajas, width=11, border=0, highlightthickness=0, anchor="e", justify="right", font=('Arial 18'), bg="#2e2e2e", fg="white")
cajaResultado = Label(cajas, width=11, border=0, highlightthickness=0, anchor="e", justify="right", font=('Arial 18'), bg="#2e2e2e", fg="white")
cajaResultado["text"] = "0"
...
boton1 = tkmacosx.Button(botonera,text="1", command= lambda: agregarKey(cajaEntrada, cajaResultado, "1"), width=40, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
boton2 = tkmacosx.Button(botonera,text="2", command= lambda: agregarKey(cajaEntrada, cajaResultado, "2"), width=40, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
boton3 = tkmacosx.Button(botonera,text="3", command= lambda: agregarKey(cajaEntrada, cajaResultado, "3"), width=40, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
boton4 = tkmacosx.Button(botonera,text="4", command= lambda: agregarKey(cajaEntrada, cajaResultado, "4"), width=40, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
boton5 = tkmacosx.Button(botonera,text="5", command= lambda: agregarKey(cajaEntrada, cajaResultado, "5"), width=40, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
boton6 = tkmacosx.Button(botonera,text="6", command= lambda: agregarKey(cajaEntrada, cajaResultado, "6"), width=40, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
boton7 = tkmacosx.Button(botonera,text="7", command= lambda: agregarKey(cajaEntrada, cajaResultado, "7"), width=40, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
boton8 = tkmacosx.Button(botonera,text="8", command= lambda: agregarKey(cajaEntrada, cajaResultado, "8"), width=40, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
boton9 = tkmacosx.Button(botonera,text="9", command= lambda: agregarKey(cajaEntrada, cajaResultado, "9"), width=40, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
boton0 = tkmacosx.Button(botonera,text="0", command= lambda: agregarKey(cajaEntrada, cajaResultado, "0"), width=91, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
botonComa = tkmacosx.Button(botonera,text=".", command= lambda: agregarKey(cajaEntrada, cajaResultado, "."), width=40, height=40, font=('Arial 18'), bg="grey", fg="white", borderwidth=5, bordercolor="grey")
...
botonMás = tkmacosx.Button(botonera,text="+", command=lambda: operacion(cajaEntrada, "+"), width=40, height=40, font=('Arial 18'), bg="orange", fg="white", borderwidth=5, bordercolor="orange")
botonMenos = tkmacosx.Button(botonera,text="-", command=lambda: operacion(cajaEntrada, "-"), width=40, height=40, font=('Arial 18'), bg="orange", fg="white", borderwidth=5, bordercolor="orange")
botonMult = tkmacosx.Button(botonera,text="x", command=lambda: operacion(cajaEntrada, "*"), width=40, height=40, font=('Arial 18'), bg="orange", fg="white", borderwidth=5, bordercolor="orange")
botonDiv = tkmacosx.Button(botonera,text="/", command=lambda: operacion(cajaEntrada, "/"), width=40, height=40, font=('Arial 18'), bg="orange", fg="white", borderwidth=5, bordercolor="orange")
botonPorc = tkmacosx.Button(botonera,text="%", command=lambda: operacion(cajaEntrada, "%"), width=40, height=40, font=('Arial 18'), bg="orange", fg="white", borderwidth=5, bordercolor="orange")
botonIgual = tkmacosx.Button(botonera,text="=", command=lambda: igual(cajaEntrada, cajaResultado), width=193, height=40, font=('Arial 18'), bg="orange", fg="white", borderwidth=5, bordercolor="orange")
...
botonC = tkmacosx.Button(botonera,text="C", command=lambda: limpiar(cajaEntrada, cajaResultado), width=40, height=40, font=('Arial 18'), bg="#84b6f4", fg="grey", borderwidth=5, bordercolor="#84b6f4")
botonDel = tkmacosx.Button(botonera,text="<", command=lambda: borrar(cajaEntrada, cajaResultado), width=40, height=40, font=('Arial 18'), bg="#84b6f4", fg="grey", borderwidth=5, bordercolor="#84b6f4")
transpMas = tkmacosx.Button(botonera, text="Transp +", command=lambda: transp("+"), width=40, height=40, font=('Arial 7'), bg="#28B463", fg="black", borderwidth=5, bordercolor="#28B463")
transpMenos = tkmacosx.Button(botonera, text="Transp -", command=lambda: transp("-"), width=40, height=40, font=('Arial 7'), bg="#ABEBC6", fg="black", borderwidth=5, bordercolor="#ABEBC6")
...
botonHist = tkmacosx.Button(botonera, text="Histórico >", command=lambda: ventanaHistórico.deiconify() if ventanaHistórico.state() == "withdrawn" else ventanaHistórico.withdraw(), width=200, height=30, font=('Arial 16'), borderless=1)
...
cajaHistórico = Listbox(ventanaHistórico, font=('Arial 18'), justify="right", bg="#2e2e2e", fg="white", highlightthickness=0)
